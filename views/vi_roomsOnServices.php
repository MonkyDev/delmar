...
$exe = new conexion;
$sql = "SELECT * FROM tbl_reservaciones
        RIGHT JOIN tbl_habitaciones ON pk_habitacion = fk_habitacion
        INNER JOIN cat_servicios ON pk_servicio = fk_servicio 
        WHERE edo_hab IN (3,4)";
  ...
  <div class="ui segment" style="height: 75vh; overflow-y: scroll; ">
    <table class="ui celled table">
      ...
      <?php while ($row = $exe->getRows($res) ) { extract($row);?>
        <tr href="#" onclick="habilitarRoom(<?php echo $pk_habitacion ?>)">
