...
$sql1 = "SELECT * FROM cat_servicios WHERE cover != 0 AND tipo_serv != 'hospedaje' ";
...
<h2 class="ui dividing header"><i class="user icon"></i>Servicio Habitación por Cliente</h2>

  <div class="ui segment" style="height: auto;">
  <form id="form_registrarVentaServicio" target="_blank" role="tooltip" class="ui form">
    ...
    <div class="field">
      ...
      <div class="ui input focus"><input placeholder="ingrese el importe total del servicio, solo números" id="importe" name="importe" required></div>
    </div>

  </form>
  </div>
  <div class="ui orange segment">
    <button class="ui primary basic button" onclick="getDataFormVentaServicio()">Guardar</button>
